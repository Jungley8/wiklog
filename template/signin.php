										...
										<div class="widget-main">
											...
											<?php echo form_open('sso/signin'); ?>
												<fieldset>
													...
													<label class="block">
														<?php echo form_error('email', "<i class=\"ace-icon fa fa-exclamation-triangle red bigger-130\"></i><span>", "</span>"); ?>
													</label>
													...
													<label class="block">
														<?php echo form_error('passwd', "<i class=\"ace-icon fa fa-exclamation-triangle red bigger-130\"></i><span>", "</span>"); ?>
													</label>
...
<!--
							...
							<div class="center">
								<h1>
									...
									<span class="red">jungley</span>
									<span class="grey" id="id-text2">管理系统</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; www.jungley.net</h4>
							</div>
